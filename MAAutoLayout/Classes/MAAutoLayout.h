...
typedef NS_OPTIONS(NSInteger, MAAutoLayoutZeroType) {
    ...
    MAAutoLayoutZeroTypeTopBottomHeight = MAAutoLayoutZeroTypeTop | MAAutoLayoutZeroTypeBottom | MAAutoLayoutZeroTypeHeight,
    MAAutoLayoutZeroTypeTopBottomWidth = MAAutoLayoutZeroTypeTop | MAAutoLayoutZeroTypeBottom | MAAutoLayoutZeroTypeWidth,
    MAAutoLayoutZeroTypeLeftRightHeight = MAAutoLayoutZeroTypeLeft | MAAutoLayoutZeroTypeRight | MAAutoLayoutZeroTypeHeight,
    MAAutoLayoutZeroTypeLeftRightWidth = MAAutoLayoutZeroTypeLeft | MAAutoLayoutZeroTypeRight | MAAutoLayoutZeroTypeWidth,
